# Universal Resume Tailoring Prompt
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank resumes across every major industry
...
- **Target Job Title** (e.g., Data Engineer, Controls Engineer, Java Developer, Business Analyst)
- **Primary Tools/Platforms** (e.g., Python + Spark + Airflow, Studio 5000 + TIA Portal + Ignition)
- **Primary Industries** (e.g., FinTech, Manufacturing, Healthcare, Oil & Gas, SaaS)
...
- Engineering/Industrial: Led, Engineered, Designed, Commissioned, Programmed, Configured, Integrated, Resolved, Validated, Deployed, Optimized, Executed, Implemented, Automated, Built
- Software/Data: Led, Engineered, Architected, Built, Deployed, Optimized, Resolved, Validated, Automated, Migrated, Refactored, Scaled, Reduced, Implemented, Delivered
- Analyst/Business: Led, Designed, Built, Optimized, Resolved, Validated, Facilitated, Documented, Analyzed, Delivered, Mapped, Coordinated, Developed, Streamlined, Identified
...
3. **If neither 1 nor 2 applies — do not include a number.** Use scope evidence instead (e.g., "across a multi-line automotive facility") or omit the quantifier entirely and describe the action plainly.
...
[... as many categories as genuinely supported, typically 5-8]
