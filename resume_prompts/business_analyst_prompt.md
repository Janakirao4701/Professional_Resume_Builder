# Business Analyst Resume Tailoring Prompt
### Works for Business Analyst roles
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank Business Analyst resumes
...
- **Target Job Title** (e.g., Business Analyst)
- **Primary Tools/Platforms** (e.g., SQL + Power BI + Jira)
- **Primary Industries** (e.g., Finance, Healthcare, E-commerce)
...
- Requirements & Analysis — Business Requirements Document (BRD), Functional Requirements Document (FRD), user stories, use cases, gap analysis, stakeholder interviews, business case development, acceptance criteria
- Process Modeling & Design — BPMN, UML, process mapping, data flow diagrams (DFD), workflow design, swimlane diagrams, Visio, Lucidchart
- Data Analysis & Reporting — SQL, Power BI, Tableau, Excel (pivot tables, VLOOKUP, macros), data validation, KPI tracking, dashboard design, ad hoc reporting
- Agile & Project Delivery — Scrum, Kanban, sprint planning, backlog grooming, story pointing, retrospectives, Azure DevOps, JIRA
- Stakeholder Management — RACI matrix, change management, executive presentations, workshop facilitation, business case sign-off, cross-functional alignment
- Tools & Documentation — JIRA, Confluence, Microsoft Visio, SharePoint, Azure DevOps, Salesforce, ServiceNow, Miro
- Domain Knowledge — Financial reporting, regulatory compliance, claims processing, EHR systems, policy management, audit workflows, reconciliation processes, HIPAA
- Testing & Validation — User Acceptance Testing (UAT) coordination, test case design, defect tracking, regression testing, test script writing, sign-off management
...
- Led, Designed, Built, Optimized, Resolved, Validated, Facilitated, Documented, Analyzed, Delivered, Mapped, Coordinated, Developed, Streamlined, Identified
...
- **Acceptable titles for this role:** Business Analyst, Senior Business Analyst, Lead Business Analyst
...
3. **If neither 1 nor 2 applies — do not include a number.** Use scope evidence instead (e.g., "across a 14-department division") or omit the quantifier entirely and describe the action plainly.
...
- **Finance company** → focus on: capital adequacy requirements, risk analysis workflows, ledger system integrations, financial report specifications.
- **Healthcare company** → focus on: EHR data migration specs, HIPAA consent workflows, patient portal requirements, medical billing flow mapping.
- **Retail/E-commerce company** → focus on: inventory management specs, shopping cart drop-off flows, order fulfillment requirements, POS system migration.
- **SaaS companies** → focus on: customer retention metrics, feature usage analytics tracking specifications, subscription billing migration workflows, user onboarding funnel optimization.
- **Manufacturing companies** → focus on: supply chain workflow mapping, inventory optimization metrics, warehouse management system integrations, production line defect tracking analytics.
...
Requirements & Analysis: skill1, skill2, skill3.
Process Modeling & Design: skill1, skill2, skill3.
Data Analysis & Reporting: skill1, skill2, skill3.
Agile & Project Delivery: skill1, skill2, skill3.
Stakeholder Management: skill1, skill2, skill3.
Tools & Documentation: skill1, skill2, skill3.
Domain Knowledge: skill1, skill2, skill3.
Testing & Validation: skill1, skill2, skill3.
