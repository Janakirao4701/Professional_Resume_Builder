# Data Engineer Resume Tailoring Prompt
### Works for Data Engineer roles
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank Data Engineer resumes
...
- **Target Job Title** (e.g., Data Engineer)
- **Primary Tools/Platforms** (e.g., Python + Spark + Airflow + Snowflake)
...
- Data Pipeline & ETL — Extract Transform Load (ETL), Apache Spark, dbt models, data ingestion, batch processing, incremental loads, pipeline observability, data quality checks
- Big Data & Streaming — Apache Kafka, Apache Spark, Spark Streaming, Apache Flink, Delta Lake, data lakehouse, real-time processing, event-driven architecture
- Cloud Platforms & Infrastructure — AWS (S3, Glue, EMR, Lambda), Azure (Data Factory, Synapse, ADLS), Google Cloud Platform (GCP) (Dataflow, BigQuery, Pub/Sub), Terraform, infrastructure as code
- Databases & Data Warehousing — Snowflake, Amazon Redshift, Google BigQuery, PostgreSQL, MySQL, schema design, data warehouse, partitioning, clustering
- Programming Languages — Python, SQL, Scala, Java, PySpark, shell scripting, data wrangling
- Orchestration & Workflow — Apache Airflow, Airflow DAGs, Prefect, Luigi, workflow scheduling, SLA compliance, retry logic
- Data Modeling & Governance — dimensional modeling, star schema, data lineage, data catalog, data contracts, metadata management, dbt, slowly changing dimensions (SCD)
- DevOps & CI/CD for Data — Docker, Kubernetes, Git, GitHub Actions, Jenkins, CI/CD pipelines, unit testing for pipelines, infrastructure as code (IaC)
...
- **Acceptable titles for this role:** Data Engineer, Senior Data Engineer, Lead Data Engineer
...
- **FinTech company** → focus on real-time transaction pipelines, fraud detection data feeds, payment reconciliation, regulatory data reporting, low-latency streaming
- **E-commerce company** → focus on clickstream data processing, recommendation engine feeds, inventory sync pipelines, customer behavior data lakes
- **Healthcare company** → focus on HL7/FHIR data ingestion, Protected Health Information (PHI)-compliant pipelines, claims data processing, clinical data warehousing, HIPAA-compliant architecture
- **Media/Streaming company** → focus on event telemetry pipelines, content engagement data, CDN log processing, viewer analytics feeds
- **SaaS company** → focus on multi-tenant data isolation, product usage telemetry, customer data platform (CDP) feeds, SaaS metrics pipelines
...
Data Pipeline & ETL: skill1, skill2, skill3.
Big Data & Streaming: skill1, skill2, skill3.
Cloud Platforms & Infrastructure: skill1, skill2, skill3.
Databases & Data Warehousing: skill1, skill2, skill3.
Programming Languages: skill1, skill2, skill3.
Orchestration & Workflow: skill1, skill2, skill3.
Data Modeling & Governance: skill1, skill2, skill3.
DevOps & CI/CD for Data: skill1, skill2, skill3.
