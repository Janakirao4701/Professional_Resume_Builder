# Controls Engineer Resume Tailoring Prompt
### Works for Controls Engineer roles
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank Controls Engineer resumes
...
- **Target Job Title** (e.g., Controls Engineer)
...
- PLC Programming & Controls — Studio 5000, RSLogix 5000, ControlLogix, CompactLogix, TIA Portal, S7-300/400/1500, GE iFIX, DCS integration, ladder logic, structured text, function block, sequential function chart
- HMI & SCADA — Ignition Perspective, Ignition SCADA, FactoryTalk View ME/SE, Wonderware InTouch, FactoryTalk Historian, alarm rationalization, historian integration
- Industrial Networking — EtherNet/IP, OPC UA, Modbus TCP/IP, PROFIBUS, DeviceNet, PROFINET, managed switches, VLAN configuration, fiber optic networks
- Electrical Design & Commissioning — AutoCAD Electrical, panel design, field wiring, loop checks, FAT (Factory Acceptance Test), SAT (Site Acceptance Test), as-built documentation, P&ID markup
- Vision & Inspection Systems — Cognex, Keyence, in-sight vision, barcode verification, dimensional inspection, vision-guided robotics (include only if applicable)
- Programming & Analytics — Python, SQL, VBA, report scripting, data trending, Excel-based analysis, KPI dashboards
- IIoT & Data — CMMS integration, MES interface, OEE (Overall Equipment Effectiveness) tracking, historian reporting, cloud dashboards, Ignition Edge
- Standards & Compliance — ISA-88, ISA-95, IEC 62443, NERC-CIP, NEC Article 500 (hazardous areas), NFPA 70E, UL 508A, P&ID interpretation
...
- **Acceptable titles for this role:** Controls Engineer, Senior Controls Engineer, Lead Controls Engineer
...
- **EPC / Engineering Firm** → FAT/SAT execution, multi-discipline engineering coordination, deliverables (loop sheets, I/O lists, cause & effect matrices), project milestone tracking
- **Oil & Gas** → SCADA historian configuration, pipeline/wellhead control, alarm rationalization, hazardous area classification (Class I Div 2, Zone 1), SIL loop verification
- **Manufacturing** → conveyor system control, robotic cell integration, OEE tracking, vision inspection systems, changeover reduction
- **Automotive** → fixture automation, VIN/barcode verification, conveyor line control, model-year changeover programming, torque tool integration
- **Water/Wastewater** → lift station SCADA, pump sequencing, remote telemetry units (RTU), EPA reporting data, SCADA historian for compliance
- **Power & Energy** → NERC-CIP compliance, substation automation, relay coordination, energy historian, DCS integration
