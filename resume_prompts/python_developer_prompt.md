# Python Developer Resume Tailoring Prompt
### Works for Python Developer roles
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank Python Developer resumes
...
- **Target Job Title** (e.g., Python Developer)
...
- Python & Frameworks — Python, FastAPI, Django, Flask, Django REST Framework, Celery, asyncio, Pydantic
- API & Backend Development — REST APIs, GraphQL, OAuth 2.0, JWT, Webhook integrations, API rate limiting, OpenAPI/Swagger, gRPC
- Data Processing & Automation — Pandas, NumPy, ETL pipelines, data transformation, background task processing, scheduled jobs, web scraping, Apache Airflow
- Cloud & DevOps — AWS Lambda, AWS EC2, AWS S3, Docker, Kubernetes, GitHub Actions, Terraform, CI/CD pipelines
- Databases & Caching — PostgreSQL, MySQL, MongoDB, Redis, SQLAlchemy, Alembic, DynamoDB, Elasticsearch
- Testing & Code Quality — pytest, unittest, coverage.py, factory_boy, mocking, TDD, code review, linting (Flake8, Black, isort)
- ML & Data Libraries — scikit-learn, TensorFlow, PyTorch, Matplotlib, Seaborn, Jupyter Notebook, Hugging Face (if applicable)
- Tools & Version Control — Git, GitHub, GitLab, JIRA, Confluence, Postman, VS Code, PyCharm
...
- **Acceptable titles for this role:** Python Developer, Senior Python Developer, Lead Python Developer
...
- **FinTech companies** → focus on: async payment processing, transaction validation, rate limiting, fraud signal detection APIs, financial data reconciliation, PCI-DSS compliant data handling.
- **Data/Analytics companies** → focus on: ETL script automation, data pipeline orchestration, reporting API development, data quality validation, transformation layer optimization.
- **HealthTech companies** → focus on: FHIR data parsers, HIPAA-compliant API design, audit logging, clinical data integrations, patient record processing.
- **SaaS companies** → focus on: multi-tenant database partitioning, API rate limiting, background task scheduling with Celery, feature flag toggle logic.
- **E-commerce companies** → focus on: shopping cart state storage in Redis, payment gateway integrations, order status webhook handlers, inventory sync event processing.
...
Python & Frameworks: skill1, skill2, skill3.
API & Backend Development: skill1, skill2, skill3.
Data Processing & Automation: skill1, skill2, skill3.
Cloud & DevOps: skill1, skill2, skill3.
Databases & Caching: skill1, skill2, skill3.
Testing & Code Quality: skill1, skill2, skill3.
ML & Data Libraries: skill1, skill2, skill3.
