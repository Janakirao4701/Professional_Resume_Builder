# .NET Developer Resume Tailoring Prompt
### Works for .NET Developer roles
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank .NET Developer resumes
...
- **Target Job Title** (e.g., .NET Developer)
- **Primary Tools/Platforms** (e.g., C# + .NET Core + Azure + SQL Server)
...
- C# & .NET Core — C#, .NET 6/7/8, ASP.NET Core, .NET Standard, LINQ, async/await, dependency injection, middleware, generics, multithreading
- Web & API Development — REST APIs, ASP.NET Core Web API, SignalR, Blazor, Razor Pages, MVC, OpenAPI/Swagger, gRPC, minimal APIs, API versioning
- Cloud & Azure Services — Microsoft Azure, Azure App Service, Azure Service Bus, Azure Functions, Azure DevOps, Azure Active Directory (AAD), Azure Blob Storage, Azure Key Vault, Azure API Management
- Databases & ORM — SQL Server, Entity Framework Core (EF Core), PostgreSQL, Azure SQL Database, Dapper, stored procedures, database migrations, query optimization, CQRS
- Microservices & Architecture — microservices architecture, MediatR, CQRS pattern, event-driven architecture, domain-driven design (DDD), API gateway, service bus integration, clean architecture
- Testing & DevOps — xUnit, NUnit, Moq, integration testing, unit testing, test-driven development (TDD), Docker, Kubernetes, GitHub Actions, Azure DevOps CI/CD pipelines
- Security & Compliance — OAuth2, OpenID Connect, JWT (JSON Web Token), role-based access control (RBAC), ASP.NET Core Identity, OWASP, HIPAA compliance, identity federation, data encryption
- Tools & Version Control — Git, GitHub, Visual Studio, Visual Studio Code, JIRA, Confluence, Agile/Scrum, NuGet, code review, pair programming
...
- **Acceptable titles for this role:** .NET Developer, Senior .NET Developer, Lead .NET Developer
...
- **Finance company** → focus on transaction APIs, reconciliation engines, audit trails, financial data processing, regulatory reporting, real-time balance computation
- **Insurance company** → focus on policy management APIs, claims processing workflows, underwriting engines, document generation services, actuarial data APIs
- **Healthcare company** → focus on Fast Healthcare Interoperability Resources (FHIR)-compliant APIs, patient data security, Electronic Health Record (EHR) integrations, HIPAA-compliant audit logging, clinical data services
- **Government** → focus on accessibility compliance (Section 508 / WCAG), FISMA compliance, identity federation, public-facing portal APIs, secure document handling
- **Enterprise Software** → focus on multi-tenant architecture, SaaS platform services, customer portal APIs, bulk data processing, platform upgrade migrations
...
C# & .NET Core: skill1, skill2, skill3.
Web & API Development: skill1, skill2, skill3.
Cloud & Azure Services: skill1, skill2, skill3.
Databases & ORM: skill1, skill2, skill3.
Microservices & Architecture: skill1, skill2, skill3.
Testing & DevOps: skill1, skill2, skill3.
Security & Compliance: skill1, skill2, skill3.
Tools & Version Control: skill1, skill2, skill3.
