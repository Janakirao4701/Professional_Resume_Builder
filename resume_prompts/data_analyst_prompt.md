# Data Analyst Resume Tailoring Prompt
### Works for Data Analyst roles
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank Data Analyst resumes
...
- **Target Job Title** (e.g., Data Analyst)
...
- Data Analysis & Visualization — KPI dashboards, cohort analysis, A/B testing, trend analysis, funnel analysis, data storytelling
- SQL & Database — SQL, T-SQL, PostgreSQL, MySQL, query optimization, stored procedures, data warehouse, joins, window functions
- Programming & Scripting — Python, pandas, NumPy, Jupyter Notebook, data wrangling, automation scripts
- BI & Reporting Tools — Power BI, Tableau, DAX, M Query, Excel, pivot tables, Power Query, SSRS
- Cloud & Data Platforms — Azure, Snowflake, dbt, Google BigQuery, AWS Redshift, Azure Data Factory
- Statistical & ML Methods — regression analysis, forecasting, clustering, hypothesis testing, statistical modeling, A/B testing
- Data Governance & Quality — data validation, data lineage, data cataloging, ETL pipelines, data quality rules, HIPAA compliance (if applicable)
- Domain & Business Knowledge — include keywords from the user's actual industries: revenue analysis, churn modeling, risk metrics, patient outcomes, claims data, sales forecasting, inventory optimization, customer segmentation, stakeholder reporting
...
- **Acceptable titles for this role:** Data Analyst, Senior Data Analyst, Lead Data Analyst
...
- **Finance company** → focus on revenue analysis, churn modeling, risk metrics, reconciliation, financial forecasting, P&L reporting
- **Healthcare company** → focus on patient outcomes, claims data analysis, HIPAA-compliant reporting, clinical metrics, utilization rates
- **Retail/E-commerce company** → focus on sales forecasting, inventory optimization, customer segmentation, basket analysis, conversion funnel
- **SaaS company** → focus on product analytics, cohort retention, MRR/ARR dashboards, funnel drop-off, feature adoption
- **Manufacturing company** → focus on production efficiency, defect rate analysis, supply chain metrics, OEE dashboards
...
Data Analysis & Visualization: skill1, skill2, skill3.
SQL & Database: skill1, skill2, skill3.
Programming & Scripting: skill1, skill2, skill3.
BI & Reporting Tools: skill1, skill2, skill3.
Cloud & Data Platforms: skill1, skill2, skill3.
Statistical & ML Methods: skill1, skill2, skill3.
Data Governance & Quality: skill1, skill2, skill3.
Domain & Business Knowledge: skill1, skill2, skill3.
