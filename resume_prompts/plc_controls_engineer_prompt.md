# PLC Controls Engineer Resume Tailoring Prompt
### Works for PLC Controls Engineer roles
...
- An **ATS Auditor** who knows exactly how Applicant Tracking Systems parse, score, and rank PLC Controls Engineer resumes
...
- **Target Job Title** (e.g., PLC Controls Engineer)
...
- PLC Programming & Controls — RSLogix 5000, Studio 5000, ControlLogix, CompactLogix, TIA Portal, S7-300/400/1200/1500, GE Fanuc, Modicon M340, ladder logic, structured text, function block diagram, sequential function chart, PID control, loop tuning
- HMI & SCADA — FactoryTalk View ME/SE, Wonderware InTouch, Ignition SCADA, Ignition Perspective, iFIX, alarm management, historian integration, trend displays
- Industrial Networking — EtherNet/IP, Modbus TCP/IP, PROFIBUS, DeviceNet, PROFINET, OPC UA, OPC DA, managed switches, network topology design
- Electrical Design & Commissioning — AutoCAD Electrical, panel design, I/O checkout, loop checks, FAT (Factory Acceptance Test), SAT (Site Acceptance Test), as-built documentation, P&ID interpretation
- Process Instrumentation — transmitter calibration, control valve sizing, level/flow/pressure/temperature instrumentation, loop tuning, instrument data sheets, HART communication
- Programming & Analytics — Python, SQL, VBA, data trending, KPI dashboards, Excel reporting, batch record analysis
- IIoT & Data — CMMS integration, MES interface, historian reporting, OEE (Overall Equipment Effectiveness) tracking, Ignition Edge, cloud data bridging
- Standards & Compliance — ISA-88, ISA-95, IEC 62443, SIL (Safety Integrity Level), FDA 21 CFR Part 11, GAMP 5, NEC Article 500, NFPA 70E, UL 508A, IQ/OQ/PQ validation
...
- **Acceptable titles for this role:** PLC Controls Engineer, Senior PLC Controls Engineer, Lead PLC Controls Engineer
...
- **Oil & Gas** → pipeline SCADA configuration, wellhead control panel programming, hazardous area compliance (Class I Division 2, Zone 1), SIL-rated safety interlock loops, alarm rationalization per ISA-18.2, compressor station control
- **Food & Beverage** → ISA-88 batch control sequence development, CIP (Clean-In-Place) automation, packaging line PLC programming, recipe management, changeover time reduction, USDA/FDA sanitary design compliance
- **Pharmaceuticals** → FDA 21 CFR Part 11 compliant SCADA configuration, GAMP 5 lifecycle documentation, IQ/OQ/PQ validation protocol execution, audit trail configuration, electronic batch records, serialization system integration
- **Chemical Processing** → interlock logic for hazardous processes, Emergency Shutdown (ESD) system programming, SIL 2 loop verification, pressure relief logic, HAZOP action implementation
- **Heavy Manufacturing** → conveyor and material handling control, press and stamping line automation, OEE tracking integration, predictive maintenance data feeds, CMMS work order triggers
...
Process Instrumentation: skill1, skill2, skill3.
Programming & Analytics: skill1, skill2, skill3.
IIoT & Data: skill1, skill2, skill3.
